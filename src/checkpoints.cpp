...
namespace Checkpoints
{
    ...
    // etercoin: synchronized checkpoint (centrally broadcasted)
    ...
    // etercoin: get last synchronized checkpoint
    ...
    // etercoin: only descendant of current sync-checkpoint is allowed
    ...
    // etercoin: reset synchronized checkpoint to last hardened checkpoint
...
// etercoin: sync-checkpoint master key
...
// etercoin: verify signature of sync-checkpoint message
...
// etercoin: process synchronized checkpoint
